...
var FileError = FileError || function() {};
 ...
 */
hterm.ScrollPort.prototype.decorate = function(div, ifr) {
  this.div_ = div;
  this.iframe_ = ifr; //div.ownerDocument.createElement('iframe');
...
hterm.Terminal.prototype.installKeyboard = function() {
  ...
  this.keyboard.installKeyboard(this.document_);
}
 ...
 */
hterm.Terminal.prototype.decorate = function(div, ifr) {
  this.div_ = div;
  this.scrollPort_.decorate(div, ifr);
  ...
  /* mouse scroll does not work on FF yet */
  this.document_.addEventListener('mousedown', onMouse);
  this.document_.addEventListener('mouseup', onMouse);
  this.document_.addEventListener('mousemove', onMouse);
  this.scrollPort_.onScrollWheel = onMouse;
...
hterm.Terminal.prototype.onMouse_ = function(e) {
  ...
  if (this.enableMouseDragScroll) {
    if (e.type == 'dblclick') {
      ...
      hterm.copySelectionToClipboard(this.document_, this.getSelectionText());
      return;
    }
...
'4e24f8f1e9e1a773bc40927b313fa86d254fcd25' +
''
);
